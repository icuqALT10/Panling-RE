...
Tags:["monster","east","common","spider"],\
CustomNameVisible:1b,CustomName:'{"translate":"plre.monster.east.spider"}',\
DeathLootTable:"plre:monsters/east/common/spider",\
attributes:\
[\
{id:"generic.max_health",base:8},\
{id:"generic.movement_speed",base:0.3},\
{id:"generic.minecraft:attack_damage",base:3},\
