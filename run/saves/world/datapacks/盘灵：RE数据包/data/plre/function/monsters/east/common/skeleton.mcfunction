...
Tags:["monster","east","common","skeleton"],\
CustomNameVisible:1b,CustomName:'{"translate":"plre.monster.east.skeleton"}',\
DeathLootTable:"plre:monsters/east/common/skeleton",\
attributes:\
[\
...
{id:"panlingre:arrow_damage",base:2},\
],\
ArmorItems:\
[\
{},\
