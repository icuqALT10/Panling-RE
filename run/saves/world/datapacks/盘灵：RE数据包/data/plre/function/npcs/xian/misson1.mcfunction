...
summon villager 3190 103 784 \
{Tags:["panling","xian","misson1"],\
CustomNameVisible:true,CustomName:'{"translate":"pl.npc.name.xianmain1"}',\
 ...
 ,can_interact:{active:true,command:"dialog show misson_xian_1"},NoAI:1b\
 }
