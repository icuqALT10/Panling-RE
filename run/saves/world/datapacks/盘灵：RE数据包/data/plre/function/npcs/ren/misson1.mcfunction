...
summon villager 1677 134 141 \
{Tags:["panling","ren","misson1"],\
CustomNameVisible:true,CustomName:'{"translate":"pl.npc.name.renmain1"}',\
 ...
 ,can_interact:{active:true,command:"dialog show misson_ren_1"},NoAI:1b\
 }
