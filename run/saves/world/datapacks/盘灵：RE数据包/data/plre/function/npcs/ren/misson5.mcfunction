...
summon villager 172 66 -158 \
{Tags:["panling","ren","misson5"],\
CustomNameVisible:true,CustomName:'{"translate":"pl.npc.name.renmain5"}',\
 ...
 ,can_interact:{active:true,command:"dialog show misson_ren_5"},NoAI:1b\
 }
