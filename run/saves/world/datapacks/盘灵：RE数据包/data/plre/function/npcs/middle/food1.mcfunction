tp @e[type=villager,distance=..5,tag=food1] ~ ~-1000 ~
summon villager 162 46 185 \
{Tags:["panling","food1"],\
CustomNameVisible:true,CustomName:'{"translate":"plre.npc.name.food1"}',\
 ...
 ,can_interact:{active:true,command:"plre opengui villager @s middle/food1"},NoAI:1b\
}