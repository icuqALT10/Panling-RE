#收购员
tp @e[type=villager,distance=..5,tag=buyer3] ~ ~-1000 ~
summon villager 84 47 112 \
{Tags:["panling","buyer3"],\
CustomNameVisible:true,CustomName:'{"translate":"plre.npc.name.buyer3"}',\
 ...
 ,can_interact:{active:true,command:"plre opengui villager @s middle/buyer3"},NoAI:1b\
}