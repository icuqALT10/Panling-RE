...
Tags:["monster","east","elite","box_skeleton"],\
CustomNameVisible:1b,CustomName:'{"translate":"plre.monster.east.box_skeleton"}',\
DeathLootTable:"plre:monsters/east/elite/box_skeleton",\
attributes:\
[\
{id:"generic.max_health",base:24},\
...
{id:"panlingre:arrow_damage",base:3},\
],\
ArmorItems:\
[\
{},\
