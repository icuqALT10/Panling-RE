execute if entity @s[tag=east] run return run function plre:monsters/east/pos

execute if entity @s[tag=south] run return run function plre:monsters/south/pos
