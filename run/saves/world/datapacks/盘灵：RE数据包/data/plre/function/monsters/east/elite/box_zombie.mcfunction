...
Tags:["monster","east","elite","box_zombie"],\
CustomNameVisible:1b,CustomName:'{"translate":"plre.monster.east.box_zombie"}',\
DeathLootTable:"plre:monsters/east/elite/box_zombie",\
attributes:\
[\
{id:"generic.max_health",base:35},\
