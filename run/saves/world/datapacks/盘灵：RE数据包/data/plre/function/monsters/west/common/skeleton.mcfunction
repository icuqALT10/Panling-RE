...
Tags:["monster","west","common","skeleton"],\
CustomNameVisible:1b,CustomName:'{"translate":"plre.monster.west.skeleton"}',\
DeathLootTable:"plre:monsters/west/common/skeleton",\
attributes:\
[\
{id:"generic.max_health",base:55},\
...
{id:"panlingre:arrow_damage",base:6},\
],\
ArmorItems:\
[\
{},\
