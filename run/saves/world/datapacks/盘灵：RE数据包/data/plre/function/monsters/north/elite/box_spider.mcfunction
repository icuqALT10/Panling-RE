...
Tags:["monster","north","elite","box_spider"],\
CustomNameVisible:1b,CustomName:'{"translate":"plre.monster.north.box_spider"}',\
DeathLootTable:"plre:monsters/north/elite/box_spider",\
attributes:\
[\
