...
Tags:["monster","west","elite","box_skeleton"],\
CustomNameVisible:1b,CustomName:'{"translate":"plre.monster.west.box_skeleton"}',\
DeathLootTable:"plre:monsters/west/elite/box_skeleton",\
attributes:\
[\
