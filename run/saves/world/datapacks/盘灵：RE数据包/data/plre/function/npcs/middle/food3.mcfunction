tp @e[type=villager,distance=..5,tag=food3] ~ ~-1000 ~
summon villager 135 46 186 \
{Tags:["panling","food3"],\
CustomNameVisible:true,CustomName:'{"translate":"plre.npc.name.food3"}',\
 ...
 ,can_interact:{active:true,command:"plre opengui villager @s middle/food3"},NoAI:1b\
}