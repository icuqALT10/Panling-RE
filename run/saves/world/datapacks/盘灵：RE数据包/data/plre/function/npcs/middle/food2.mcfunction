tp @e[type=villager,distance=..5,tag=food2] ~ ~-1000 ~
summon villager 147 46 184 \
{Tags:["panling","food2"],\
CustomNameVisible:true,CustomName:'{"translate":"plre.npc.name.food2"}',\
 ...
 ,can_interact:{active:true,command:"plre opengui villager @s middle/food2"},NoAI:1b\
}