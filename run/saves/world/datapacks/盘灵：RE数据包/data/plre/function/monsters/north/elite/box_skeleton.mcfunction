...
Tags:["monster","north","elite","box_skeleton"],\
CustomNameVisible:1b,CustomName:'{"translate":"plre.monster.north.box_skeleton"}',\
DeathLootTable:"plre:monsters/north/elite/box_skeleton",\
attributes:\
[\
...
{id:"panlingre:arrow_damage",base:10},\
],\
ArmorItems:\
[\
{},\
