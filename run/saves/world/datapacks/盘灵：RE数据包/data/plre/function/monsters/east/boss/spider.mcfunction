...
Tags:["monster","east","boss","spider"],\
CustomNameVisible:1b,CustomName:'{"translate":"plre.monster.east.bossspider"}',\
DeathLootTable:"plre:monsters/east/boss/spider",\
attributes:\
[\
{id:"generic.max_health",base:240},\
