...
Tags:["monster","south","elite","box_zombie"],\
CustomNameVisible:1b,CustomName:'{"translate":"plre.monster.south.box_zombie"}',\
DeathLootTable:"plre:monsters/south/elite/box_zombie",\
attributes:\
[\
