tp @e[type=villager,distance=..5,tag=misson4] ~ ~-1000 ~
summon villager 1655 153 174 \
{Tags:["panling","ren","misson4"],\
CustomNameVisible:true,CustomName:'{"translate":"pl.npc.name.renmain4"}',\
 ...
 ,can_interact:{active:true,command:"dialog show misson_ren_4"},NoAI:1b\
 }
