tp @e[type=villager,distance=..5,tag=te1] ~ ~-1000 ~
summon villager 837 40 110 \
{Tags:["panling","te1"],\
CustomNameVisible:true,CustomName:'{"translate":"plre.npc.name.te1"}',\
 ...
 ,can_interact:{active:true,command:"dialog show npc_east_te1"},NoAI:1b\
}