...
Tags:["monster","west","common","cave_spider"],\
CustomNameVisible:1b,CustomName:'{"translate":"plre.monster.west.cave_spider"}',\
DeathLootTable:"plre:monsters/west/common/cave_spider",\
attributes:\
[\
