...
Tags:["monster","east","elite","box_spider"],\
CustomNameVisible:1b,CustomName:'{"translate":"plre.monster.east.box_spider"}',\
DeathLootTable:"plre:monsters/east/elite/box_spider",\
attributes:\
[\
