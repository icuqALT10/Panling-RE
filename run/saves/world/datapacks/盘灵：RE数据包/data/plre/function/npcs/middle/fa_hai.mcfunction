tp @e[type=villager,distance=..5,tag=fa_hai] ~ ~-1000 ~
summon villager 243 64 -205 \
{Tags:["panling","middle","fa_hai"],\
CustomNameVisible:true,CustomName:'{"translate":"pl.npc.name.mainx"}',\
 ...
 ,can_interact:{active:true,command:"dialog show misson_middle_fa_hai"},NoAI:1b\
 }
