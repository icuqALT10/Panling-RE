...
Tags:["monster","south","elite","box_skeleton"],\
CustomNameVisible:1b,CustomName:'{"translate":"plre.monster.south.box_skeleton"}',\
DeathLootTable:"plre:monsters/south/elite/box_skeleton",\
attributes:\
[\
{id:"generic.max_health",base:50},\
...
{id:"panlingre:arrow_damage",base:5},\
],\
ArmorItems:\
[\
{},\
{},\
{},\
{id:"minecraft:golden_helmet",count:1b,components:{unbreakable:{},enchantments:{thorns:2}}}\
],\
HandItems:\
[\
{id:"minecraft:bow",components:{unbreakable:{},enchantments:{flame:1,punch:1}}},\
{}\
],\
