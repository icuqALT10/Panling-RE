...
public class XingHaiModel extends GeoModel<XingHaiEntity> {
    ...
    public ResourceLocation getModelResource(XingHaiEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath("panlingre", "geo/entity/xing_hai.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(XingHaiEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath("panlingre", "textures/entity/xing_hai.png");
    }

    @Override
    public ResourceLocation getAnimationResource(XingHaiEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath("panlingre", "animations/entity/xing_hai.animation.json");
    }
}