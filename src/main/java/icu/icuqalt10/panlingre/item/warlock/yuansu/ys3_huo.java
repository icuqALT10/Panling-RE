...
public class ys3_huo extends Item {
    private static final int COOLDOWN = 1800;
    private static final float COST = 80.0F;

    public ys3_huo() { super(new Properties().stacksTo(64).fireResistant()); }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (level instanceof ServerLevel serverLevel) {
            ...
            serverLevel.playSound(null, player.getX(), player.getY(), player.getZ(),
                    ModSounds.YS_HUO, SoundSource.PLAYERS, 0.5F, 1.0F);
            player.displayClientMessage(Component.translatable("item.PanlingRE.ys3_huo.skill.success"), true);
        }
    ...
    public void appendHoverText(ItemStack stack, @Nullable TooltipContext context,
        ...
        if (SafeClientAccess.isShiftPressed()) {
            ...
            tooltip.add(Component.translatable("item.PanlingRE.ys3_huo.skill2",
            ...
            tooltip.add(Component.translatable("item.PanlingRE.ys3_huo.skill3"));
            tooltip.add(Component.translatable("item.PanlingRE.ys3_huo.skill4"));
            tooltip.add(Component.translatable("item.PanlingRE.ys3_huo.skill5"));
        } else {
            tooltip.add(Component.translatable("item.PanlingRE.ys3_huo.skill1.1"));
        }
        super.appendHoverText(stack, context, tooltip, flag);
    }
}
