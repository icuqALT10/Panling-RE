...
public class pi_gu_2 extends PotionItem {
    ...
    public pi_gu_2() {
        super(new Properties()
                ...
                .component(DataComponents.POTION_CONTENTS, new PotionContents(
                        ...
                        Optional.of(2293580),
                        List.of(
                                new MobEffectInstance(MobEffects.REGENERATION, 1200, 1,false,false,true),
                                new MobEffectInstance(MobEffects.SATURATION, 1, 5,false,false,true)
                        ))));
    }

    @Override
    public Component getName(ItemStack stack) {
        return Component.translatable("item.panlingre.pi_gu_2");
    }
