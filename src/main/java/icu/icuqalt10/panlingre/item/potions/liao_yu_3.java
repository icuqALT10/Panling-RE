...
public class liao_yu_3 extends PotionItem {
    ...
    public liao_yu_3() {
        super(new Properties()
                ...
                .component(DataComponents.POTION_CONTENTS, new PotionContents(
                        ...
                        List.of(
                                new MobEffectInstance(MobEffects.HEAL, 1, 2,false,false,true),
    ...
    public Component getName(ItemStack stack) {
        return Component.translatable("item.panlingre.liao_yu_3");
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        ...
        if (entity instanceof Player player) {
            cooldown_remove.cd_remove(player, this, 150);
