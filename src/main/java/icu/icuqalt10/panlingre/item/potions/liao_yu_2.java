...
public class liao_yu_2 extends PotionItem {
    ...
    public liao_yu_2() {
        super(new Properties()
                ...
                .component(DataComponents.POTION_CONTENTS, new PotionContents(
                        ...
                        List.of(
                                new MobEffectInstance(MobEffects.HEAL, 1, 1,false,false,true),
                                new MobEffectInstance(MobEffects.REGENERATION, 300, 0,false,false,true)
                        ))));
    }

    @Override
    public Component getName(ItemStack stack) {
        return Component.translatable("item.panlingre.liao_yu_2");
    }
