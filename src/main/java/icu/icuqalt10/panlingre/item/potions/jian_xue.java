...
public class jian_xue extends CustomPelletItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable TooltipContext context, List<Component> tooltipComponents, TooltipFlag flag) {
        ...
        tooltipComponents.add(Component.translatable("item.panlingre.jian_xue.skill1"));
        tooltipComponents.add(Component.translatable("item.panlingre.jian_xue.skill2"));
        tooltipComponents.add(Component.translatable("item.panlingre.jian_xue.skill3"));
    }
}
