...
public class hui_chun_1 extends CustomPelletItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable TooltipContext context, List<Component> tooltipComponents, TooltipFlag flag) {
        ...
        tooltipComponents.add(Component.translatable("item.panlingre.hui_chun_1.skill1"));
        tooltipComponents.add(Component.translatable("item.panlingre.hui_chun_1.skill2"));
        tooltipComponents.add(Component.translatable("item.panlingre.hui_chun_1.skill3"));
    }
}
