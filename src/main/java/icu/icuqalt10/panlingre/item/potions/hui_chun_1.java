...
public class hui_chun_1 extends CustomPelletItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("item.panlingre.hui_chun_1.skill1", cooldown_remove.getCooldownText(SafeClientAccess.getClientPlayer(), cooldown)));
        tooltip.add(Component.translatable("item.panlingre.hui_chun_1.skill2"));
    }
}
