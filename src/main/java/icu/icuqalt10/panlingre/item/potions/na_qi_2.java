...
public class na_qi_2 extends PotionItem {
    ...
    public na_qi_2() {
        super(new Properties()
                ...
                .component(DataComponents.POTION_CONTENTS, new PotionContents(
                        ...
                        Optional.of(118504),
                        List.of(
                                new MobEffectInstance(ModEffects.ling_qi_recovery, 1200, 2,false,false,true)
                        ))));
    }

    @Override
    public Component getName(ItemStack stack) {
        return Component.translatable("item.panlingre.na_qi_2");
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        ...
        if (entity instanceof Player player) {
            cooldown_remove.cd_remove(player, this, 500);
