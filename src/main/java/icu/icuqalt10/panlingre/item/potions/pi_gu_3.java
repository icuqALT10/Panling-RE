...
public class pi_gu_3 extends PotionItem {
        ...
        super(new Properties()
                ...
                .component(DataComponents.POTION_CONTENTS, new PotionContents(
                        ...
                        List.of(
                                ...
                                new MobEffectInstance(MobEffects.SATURATION, 1, 9,false,false,true)
                        ))));
    }

    @Override
    public Component getName(ItemStack stack) {
        return Component.translatable("item.panlingre.pi_gu_3");
    }
