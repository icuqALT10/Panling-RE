...
public class na_qi_3 extends PotionItem {
    ...
    public na_qi_3() {
        super(new Properties()
                ...
                .component(DataComponents.POTION_CONTENTS, new PotionContents(
                        ...
                        Optional.of(118504),
                        List.of(
                                new MobEffectInstance(ModEffects.ling_qi_recovery, 300, 4,false,false,true)
                        ))));
    }

    @Override
    public Component getName(ItemStack stack) {
        return Component.translatable("item.panlingre.na_qi_3");
    }
