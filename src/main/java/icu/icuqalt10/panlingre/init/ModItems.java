...
import icu.icuqalt10.panlingre.item.warlock.armor.*;
import icu.icuqalt10.panlingre.item.warlock.yuansu.*;
...
public class ModItems {
    ...
    public static final DeferredItem<Item> ys2_jin = ITEMS.register("ys2_jin", ys2_jin::new);
    public static final DeferredItem<Item> ys2_mu = ITEMS.register("ys2_mu", ys2_mu::new);
    ...
    public static final DeferredItem<Item> na_qi_1 = ITEMS.register("na_qi_1", na_qi_1::new);
    public static final DeferredItem<Item> na_qi_2 = ITEMS.register("na_qi_2", na_qi_2::new);
    public static final DeferredItem<Item> na_qi_3 = ITEMS.register("na_qi_3", na_qi_3::new);
