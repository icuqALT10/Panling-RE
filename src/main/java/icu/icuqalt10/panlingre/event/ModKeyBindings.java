...
public class ModKeyBindings {
    ...
    //注册按键 并 分配ID
    public static final KeyMapping SKILL_1 = register("skill_1", InputConstants.Type.MOUSE, 3, 1);
    public static final KeyMapping SKILL_2 = register("skill_2", InputConstants.Type.MOUSE, 4, 2);
